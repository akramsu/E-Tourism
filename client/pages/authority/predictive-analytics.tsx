    ...
    <div className="space-y-6 p-4">
      ...
      {predictiveData && (
        <div className="grid gap-6 md:grid-cols-2">
          <ForecastChart 
            data={predictiveData.visitorScenarios.map(scenario => ({
              forecastDate: scenario.month,
              predictedVisitors: scenario.realistic,
              confidenceInterval: {
                lower: scenario.pessimistic,
                upper: scenario.optimistic
              },
              scenario: 'realistic',
              accuracy: scenario.confidence
            }))}
          ...
          <AIInsightsPanel 
            ...
            accuracy={predictiveData.modelAccuracy}
          />
        </div>
      )}
